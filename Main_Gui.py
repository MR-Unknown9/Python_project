...
B_1 = ttk.Button(Info_frame, text="Page 1", style="info.TButton", width=10).grid(
    row=0, column=0, sticky=N, padx=10, pady=5
)
B_2 = ttk.Button(Info_frame, text="Page 2", style="info.TButton", width=10).grid(
    row=0, column=1, sticky=N, padx=10, pady=5
)
B_3 = ttk.Button(Info_frame, text="Page 3", style="info.TButton", width=10).grid(
    row=0, column=2, sticky=N, padx=10, pady=5
)
B_4 = ttk.Button(Info_frame, text="Page 4", style="info.TButton", width=10).grid(
    row=0, column=3, sticky=N, padx=10, pady=5
)
B_5 = ttk.Button(Info_frame, text="Page 5", style="info.TButton", width=10).grid(
    row=0, column=4, sticky=N, padx=10, pady=5
)

# *****

# masege
Hellow_masege = ttk.Label(
    window, text="Online Shopping", font="roboto 35 bold", foreground="#6EACDA"
).place(x=500, y=100)
Hellow_masege_2 = ttk.Label(
    window,

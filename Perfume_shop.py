...
class PerfumeShopApp:
    ...
    def create_widgets(self):
        title_label = ttk.Label(self.window, text="Perfume Shop", foreground="#E2E2B6", font=('ADLaM Display', 35, 'bold'),background="#fdf5df")
    ...
    def save_product_data(self):
        try:
            conn = sqlite3.connect(DATABASE_FILE)
            cursor = conn.cursor()
            cursor.execute('CREATE TABLE IF NOT EXISTS product_perfum (name TEXT, brand TEXT, price REAL, image_name TEXT)')

...
class LoginApp:
    ...
    def setup_login_frame(self):
        ...
        username_label = ttk.Label(
            username_frame, text="Username", font="roboto 18 bold"
        )
        ...
        password_label = ttk.Label(
            password_frame, text="Password", font="roboto 18 bold"
        )
        ...
        login_button = ttk.Button(
            self.login_frame, text="Login", width=20, command=self.handle_login
        )
        ...
        signup_button = ttk.Button(
            signup_prompt_frame, text="Sign up", command=self.open_signup
        )
    ...
    def setup_signup_frame(self):
        signup_title = ttk.Label(
            self.signup_frame, text="Sign Up", font="roboto 25 bold"
        )
        ...
        signup_password_label = ttk.Label(
            password_frame, text="Password", font="roboto 18 bold"
        )
        ...
        signup_button = ttk.Button(
            self.signup_frame, text="Sign Up", width=20, command=self.handle_signup
        )
        signup_button.pack(pady=20)

        back_to_login_button = ttk.Button(
            self.signup_frame, text="Back to Login", command=self.return_to_login
        )
